...
public class RegistryResponseErrorTest {
    private static final String EXPECTED =
        ...
        "<ns3:RegistryError errorCode=\"XDSRepositoryError\" codeContext=\"This is an error!\" " +
    ...
    private static final String EXPECTED_XML_TAGS_IN_CODECONTEXT =
        ...
        "status=\"urn:oasis:names:tc:ebxml-regrep:ResponseStatusType:Failure\">" +
        "<ns3:RegistryErrorList highestSeverity=\"urn:oasis:names:tc:ebxml-regrep:ErrorSeverityType:Error\">" +
        "<ns3:RegistryError errorCode=\"XDSRepositoryError\" codeContext=\"&lt;error&gt;This is an error!&lt;/error&gt;\" " +
        "severity=\"urn:oasis:names:tc:ebxml-regrep:ErrorSeverityType:Error\"/>" +
        "</ns3:RegistryErrorList>" +
        "</ns3:RegistryResponse>" +
        "</env:Body>" +
    ...
    private static final String EXPECTED_MULTIPLE_ERRORS =
        ...
        "<ns3:RegistryError errorCode=\"XDSRepositoryError\" codeContext=\"This is an error!\" " +
        "severity=\"urn:oasis:names:tc:ebxml-regrep:ErrorSeverityType:Error\"/>" +
        "<ns3:RegistryError errorCode=\"XDSRepositoryError\" codeContext=\"This is another error!\" " +
        "severity=\"urn:oasis:names:tc:ebxml-regrep:ErrorSeverityType:Error\"/>" +
        "<ns3:RegistryError errorCode=\"XDSUnknownPatientId\" codeContext=\"The patient is unknown!\" " +
        "severity=\"urn:oasis:names:tc:ebxml-regrep:ErrorSeverityType:Error\"/>" +
        "</ns3:RegistryErrorList>" +
        "</ns3:RegistryResponse>" +
        "</env:Body>" +
